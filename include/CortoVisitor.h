...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitIn_declaration(CortoParser::In_declarationContext *context) = 0;
    ...
    virtual antlrcpp::Any visitInout(CortoParser::InoutContext *context) = 0;
